...
<div v-if="!filter_group_id" class="flex flex-col">
    ...
    <filter-group :api_base="api_base" :active_filters="active_filters" :values="null" :flat="false" endpoint="mediums" name="Medium" query_parameter="medium[]" @filter-selected="onFilterSelected" @filter-removed="onFilterRemoved"/>
    <filter-group :api_base="api_base" :active_filters="active_filters" :values="null" :flat="false" endpoint="techniques" name="Technique" query_parameter="technique[]" @filter-selected="onFilterSelected" @filter-removed="onFilterRemoved"/>
